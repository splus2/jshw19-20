...
/* 1. An array of skills ('skills' field) of all people, should not be repetitive skills,
they also need to be sorted alphabetically */

// creates the array of 'skills' values
var skillsAllPeople = _.map(arrData, 'skills');
// flattens that array of nested levels deep
var allSkills = _.flattenDeep(skillsAllPeople);
// creates a duplicate-free version of that array
var uniqSkills = _.uniq(allSkills);
// gives all the internal array element to lowercase 
var lowerCaseSkills = _.mapValues(uniqSkills, function(val) {
...
// creates the array of elements, sorted in ascending order
var sortSkills = _.sortBy(lowerCaseSkills);

console.log('Sorted Skills of All People: ', sortSkills);

/* 2. An array of names ('name' fields) of people, sorted according to the number
of their friends ('friends') */

// creates the array of elements, sorted according to the number of their friends
var sortedByFriends = _.sortBy(arrData, function(o) {
	return o.friends.length;
});
// creates the array of 'name' values
var arrNames = _.map(sortedByFriends, 'name');

console.log('People Names Sorted by Friends: ', arrNames);

/* 3. An array of all friends of all users should not be 
repetitive of people */

// creates the array of 'friends' values
var friendsAllUsers = _.map(arrData, 'friends');
// flattens that array of nested levels deep
var allFriends = _.flattenDeep(friendsAllUsers);
// creates the array of 'name' values
var nameFriends = _.map(allFriends, 'name');
//  creates a duplicate-free version of that array
var uniqNameFriends = _.uniq(nameFriends);

console.log('An Array of All Friends of All Users: ', uniqNameFriends);